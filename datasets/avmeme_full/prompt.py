...
SYSTEM_PROMPT = (
    "You are an audio-visual meme understanding evaluator. "
    "Watch and listen to the provided media carefully. "
    "Infer the meme's intended meaning, emotional tone, implied social context, humor, "
    "and typical online usage when relevant. "
    "Follow the requested answer format exactly."
)
...
def build_prompt(question, options=None):
    ...
    used_labels = labels[:len(options or [])] or labels[:4]
    choices = "\n".join(
        f"{label}. {option}"
