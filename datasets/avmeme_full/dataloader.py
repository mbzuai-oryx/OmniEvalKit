...
DATASET_NAME = "avmeme_full"
ANNOTATION_FILES = ('avmeme_full_v01_public.json', 'avmeme_full.jsonl')
# ANNOTATION_FILES = ('avmeme_full_qwen25omni_correct_qwen25vlomni_english_wrong.json', 'avmeme_full.jsonl')
eval_type = "closed"
