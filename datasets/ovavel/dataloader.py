...
DATASET_NAME = "ovavel"
ANNOTATION_FILES = ('ovavel_test.jsonl', 'ovavel.jsonl')
# OVAVEL is event localization rather than standard QA; run_eval needs one mode, so use open for direct localization text.
eval_type = "open"
