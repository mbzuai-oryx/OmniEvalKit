...
DATASET_NAME = "ovobench"
ANNOTATION_FILES = ('ovobench.jsonl',)
# OVO-Bench mixes MCQ and QA, but the benchmark is usually scored as choice-based; use closed while preserving free-form rows.
eval_type = "closed"
